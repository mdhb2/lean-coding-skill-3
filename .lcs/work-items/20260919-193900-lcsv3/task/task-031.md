---
title: "TASK-031: Skill-gen: lcs3-master (router)"
...
depends_on: [TASK-003]
mode: "AFK"
summary: "Rewrite lcs-master; skill inventory derived from migration-matrix.md, not hardcoded (row 10)."
related_fr: []
related_ac: []
related_test: []
---

# TASK-031: Skill-gen: lcs3-master (router)

## Scope
Rewrite lcs-master; skill inventory derived from migration-matrix.md, not hardcoded (row 10).
