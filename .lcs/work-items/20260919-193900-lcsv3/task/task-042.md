---
title: "TASK-042: Skill-gen: lcs3-wizard"
...
depends_on: [TASK-003]
mode: "AFK"
summary: "Rewrite lcs-wizard interactive script output path (row 22)."
related_fr: []
related_ac: []
related_test: []
---

# TASK-042: Skill-gen: lcs3-wizard

## Scope
Rewrite lcs-wizard interactive script output path (row 22).
