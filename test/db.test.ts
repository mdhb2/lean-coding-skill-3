...
describe("SQLite bootstrap (SRC-017/018)", () => {
  it("empty DB initializes at SCHEMA_VERSION with bookkeeping table", () => {
    ...
    assert.deepEqual(res.applied, ["base-schema-migrations", "runtime-tasks-table", "runtime-task-scopes-table", "runtime-task-retries-table", "runtime-review-findings-table"]);
